  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Jurnal de acces</a> </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Gestionați jurnalul de autentificari</h3>
      </div>
      <div class="row-fluid">
        <div class="span12">
              ...
              <table class="table table-hover table-condensed" id="example">
                <thead>
                  <tr>
                    ...
                    <th style="width:10%">Nume utilizator</th>
                      <th style="width:10%">Email </th>
                             <th style="width:18%">Data autentificare| Ora autentificare </th>
                    <th style="width:10%" data-hide="phone,tablet">IP</th>
                    <th style="width:15%">Mac id</th>
                    <th style="width:12%" data-hide="phone,tablet">Oras </th>
