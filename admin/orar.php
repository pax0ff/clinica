	  ...
	  <!-- END DASHBOARD TILES -->
		   ...
		   <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="home.php" class="active">Acasa</a>
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
                                            ...
                                            <table class="table table-hover no-more-tables">
                                                ...
                                                <tbody>
                                                <?php $ret=mysqli_query($con,"SELECT * FROM cabinet JOIN asistenta ON cabinet.medic_id = asistenta.id ");
												$cnt=1;
                                                    ...
                                                    <tr>
														...
														<td><?php echo $row['nume'];?></td>
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           <a href="edit-cabinet.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-xs btn-mini">View n Edit</a> 
