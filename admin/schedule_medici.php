...
if(isset($_POST['adauga'])) {
    if(empty($_POST['doctor'])) {
        $errors[] = "Doctorul nu a fost ales";
    }
    else {
        $doctor = $_POST['doctor'];
    }
     if(empty($_POST['cabinet'])) {
        $error[] = "Cabinetul nu a fost ales";
    }
     else {
    ...
    if(count($errors)>0) {
        ...
        $insertQuery = mysqli_query($con,"INSERT INTO `program_medical`(`id`, `doctor`, `cabinet`, `data`, `ora_intrare`, `ora_iesire`) VALUES (NULL,'$doctor','$cabinet','$data','$ora_intrare','$ora_iesire')");
        //print_r($insertQuery);
    }
...
<div class="page-content">
    ...
    <div class="clearfix"></div>
        <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="grid simple ">
                                ...
                                <form method="post" action="schedule_medici.php">
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 p-t-15">
                                        ...
                                        <select class="form-select" name="doctor" aria-label="Default select example">
                                            ...
                                            <?php
                                            while($row=mysqli_fetch_array($doctori)) {
                                            ?>
            ...
            <?php $ret=mysqli_query($con,"select * from program_medical order by data DESC"); ?>
        <div class="row">
